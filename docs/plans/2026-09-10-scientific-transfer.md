...
| R1 | Trajectories and numerical validation | Split by scene/seed before fitting; dt refinement, particle counts, gravity, velocities, boundaries; units, hashes, provenance | Planned |
...
and source SHA-256 values. Next, extend the generator with scene-level splits and
time-step refinement checks; keep generated targets out of policy observations.
