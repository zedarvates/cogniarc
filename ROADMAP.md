...
- [ ] Prepare a separate predictor protocol with explicit known gravity and zero net internal momentum change, using fresh reserved scenes. Diagnose high-stiffness drift and changing neighbour support separately; conservation alone cannot establish accuracy. Keep all earlier predictors/evidence frozen.
